...
# submits a simple job via the dirac api
...
j.setCPUTime(500)
j.setExecutable('run')
j.setInputSandbox('/home/eepgmmg1/workspace/git/stamina/facs-dev/jobs/dirac/run')	
#j.setParameterSequence('InputData', inputDataList, addToWorkflow=True)
#j.setInputData(['/home/eepgmmg1/workspace/git/stamina/facs-dev/jobs/dirac/run'])
j.setName('API')
